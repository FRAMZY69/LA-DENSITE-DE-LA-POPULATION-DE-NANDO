...
map.getView().fit([-465477.027745, 1222861.340244, -7098.737963, 1447210.122786], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LA DENSITE DE LA POPULATION DE NANDO PAR COMMUNES</h2>';
        return titleElement;
    })(),
